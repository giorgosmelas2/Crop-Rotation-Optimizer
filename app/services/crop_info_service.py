...
def fetch_crop_info(crop_names: list[str]) -> list[Crop]:
    ...
    for crop_name in crop_names:
        ...
        try:
            ...
            crop_climate = supabase.table("crop_climate") \
                .select("*") \
        ...
        if crop and crop_climate and crop_nutrients and ressidue_returns and soil_type and pest_name: 
            ...
            crops.append(
                Crop(
                    ...
                    t_min = crop_climate[0]["t_min"],
                    t_max = crop_climate[0]["t_max"],
                    t_opt_min = crop_climate[0]["t_opt_min"],
                    t_opt_max = crop_climate[0]["t_opt_max"],
                    rain_min_mm = crop_climate[0]["rain_min"],
