...
from experiment_optimizer import experiment_optimize_rotation_plan
...
def main():
    ...
    # best_individual, best_score, gens_best_fitness, gens_avg_fitness, gens_variance, gens_worst_fitness= experiment_optimize_rotation_plan(
    ...
    #         years=years,
    #     )
    experiment_optimize_rotation_plan(
            selected_crops=selected_crops,
            pest_manager=pest_manager,
            field=field,
            climate=climate,
