...
def random_dummy_climate():
    ...
    return Climate(
        monthly_tmin=[7, 8, 10, 13, 17, 21, 24, 24, 21, 17, 13, 9], 
        monthly_tmax=[14, 15, 18, 21, 26, 31, 34, 34, 29, 24, 20, 15], 
        monthly_rain=[51.9, 42.3, 41.6, 25.2, 18.4, 18.2, 6.5, 5.4, 21.7, 28.4, 67.6, 69.2], 
        monthly_evap=[32, 36, 62, 95, 132, 166, 190, 180, 125, 85, 48, 30],
        monthly_rh=[0.68, 0.69, 0.63, 0.56, 0.54, 0.49, 0.41, 0.39, 0.51, 0.61, 0.68, 0.69]  
    )
...
def random_dummy_farmer_knowledge():
    ...
    pair1 = CropPair(crop1='Βαμβάκι', crop2='Αγγούρι', value=3)
    effective_pairs.append(pair1)
    pair2 = CropPair(crop1='Σουσάμι', crop2='Κριθάρι', value=1)
    effective_pairs.append(pair2)
    pair3 = CropPair(crop1='Τομάτα', crop2='Σπανάκι', value=2)
    effective_pairs.append(pair3)

    unpair1 = CropPair(crop1='Καρπούζι', crop2='Αγγούρι', value=3)
    uneffective_pairs.append(unpair1)
    unpair2 = CropPair(crop1='Σπανάκι', crop2='Κριθάρι', value=1)
    uneffective_pairs.append(unpair2)
    unpair3 = CropPair(crop1='Λάχανο', crop2='Σπανάκι', value=2)
    uneffective_pairs.append(unpair3)
...
def random_dummy_beneficial_rotations():
    ...
    return [
        ['Σιτάρι', 'Ελαιόκαμβη'],
        ['Βαμβάκι', 'Αγγούρι', 'Σουσάμι'],
        ['Τομάτα', 'Σπανάκι', 'Καρπούζι'],
    ]
