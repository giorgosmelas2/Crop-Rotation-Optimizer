...
def dummy_pest_agents():
    return [
        ...
        PestAgent(name='Cotton bollworm', affected_crops=['Βαμβάκι'], affected_families=['Malvaceae'], affected_orders=['Malvales']),
        ...
        PestAgent(name='Pea aphid', affected_crops=['Φακή'], affected_families=['Fabaceae'], affected_orders=['Fabales']),
        PestAgent(name='Black bean aphid', affected_crops=['Κούκι'], affected_families=['Fabaceae'], affected_orders=['Fabales']),
        PestAgent(name='Pea weevil', affected_crops=['Κτηνοτροφικό μπιζέλι'], affected_families=['Fabaceae'], affected_orders=['Fabales']),
        ...
        PestAgent(name='Onion thrips', affected_crops=['Κρεμμύδι', 'Σκόρδο'], affected_families=['Amaryllidaceae'], affected_orders=['Asparagales']),
        PestAgent(name='Carrot fly', affected_crops=['Καρότο'], affected_families=['Apiaceae'], affected_orders=['Apiales']),
...
def dummy_past_pest_agents():
    ...
    all_agents = dummy_pest_agents() 
    return [
        agent for agent in all_agents
        if any(c in agent.affected_crops for c in past_crops)
    ]
    

def dummy_pest_manager():
